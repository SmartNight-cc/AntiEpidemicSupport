...
public class PostFragment extends Fragment {
    ...
    public LinkedList<Post> list_post;
    ...
    public void initData() {
        ...
        postAdapter pAdapter = new postAdapter(list_post,view.getContext());
    ...
    private void updateData(int position) {
        ...
        if (position >= firstVisiblePosition && position <= lastVisiblePosition) {
            ...
            if (view.getTag() instanceof postAdapter.ViewHolder) {
                //获取指定view对应的ViewHolder
                postAdapter.ViewHolder viewHolder= (postAdapter.ViewHolder) view.getTag();
                if (p.getConcerned())
